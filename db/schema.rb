...
ActiveRecord::Schema.define(version: 2020_04_16_121600) do
  ...
  create_table "cources", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "cource"
    t.integer "time"
    t.integer "price"
